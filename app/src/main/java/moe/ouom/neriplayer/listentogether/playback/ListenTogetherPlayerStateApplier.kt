...
internal class ListenTogetherPlayerStateApplier(
    ...
    fun apply(
        ...
        val shouldClearUnavailableAuthoritativeStream =
            causeType == "LINK_UNAVAILABLE" && !isControllerProvider()
