...
- 🎵 **本地音频导入与扫描**：
  ...
  并自动识别附近歌词与封面 sidecar 文件。
- 👤 **本地歌手分类与详情**：
  本地歌曲会按展示艺术家自动分组；本地歌手页支持播放全部、多选、
...
- ✨ **播放页动效与歌词**：
  ...
  歌词编辑、歌词字体调节、歌词触感反馈和 Lyrics 全屏页。
- 🪟 **悬浮歌词与状态栏歌词**：
...
我们非常重视你的隐私安全和账号安全，因此同步策略刻意保持去中心化：
