...
- **仿 Apple Music 的深度歌词体验**：
  ...
  悬浮歌词、Lyricon、蓝牙歌词和歌词编辑也复用同一条播放数据链路。
- **完整的本地歌曲管理链路**：
...
- **高个性化，不只是换主题色**：
  ...
  主题风格、UI 缩放、自定义背景、歌词字号、歌词模糊、播放页流体背景、
  首页卡片开关、默认启动页，以及歌曲自定义名称、歌手和封面等细粒度选项。
- **ANR、崩溃和安全模式都纳入诊断闭环**：
